...
inline void as_init_textured_material(Material::Textured<TextureHandle>* texturedMaterial)
{
  *texturedMaterial = Material::Textured<TextureHandle>();
  ...
  texturedMaterial->height_map = TextureManager::instance()->handleFor(uuids::blackTexture);
...
void Material::registerAngelScriptTypes()
{
  ...
  r = angelScriptEngine->RegisterObjectProperty(type, "vec4 srmo_range_0", asOFFSET(Material::Textured<TextureHandle>, srmo_range_0)); AngelScriptCheck(r);
  r = angelScriptEngine->RegisterObjectProperty(type, "vec4 srmo_range_1", asOFFSET(Material::Textured<TextureHandle>, srmo_range_1)); AngelScriptCheck(r);
