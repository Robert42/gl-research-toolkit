...
GLSLMacroWrapper<int> SDFSAMPLING_SPHERE_TRACING_MAX_NUM_LOOPS("#define SDFSAMPLING_SPHERE_TRACING_MAX_NUM_LOOPS %0", 256);
...
GLSLMacroWrapper<bool> AO_IGNORE_FALLBACK_SDF("#define AO_IGNORE_FALLBACK_SDF %0", true);
