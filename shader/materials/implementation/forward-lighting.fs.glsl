...
#if defined(DISTANCEFIELD_AO) || defined(DISTANCEFIELD_AO_COST_TEX) || defined(DISTANCEFIELD_AO_COST_CONE_SPHERE_INTERSECTION_TEST) || defined(DISTANCEFIELD_AO_COST_SDF_ARRAY_ACCESS) || defined(DISTANCEFIELD_AO_COST_NUM_CONETRACED_SDF) || defined(DISTANCEFIELD_AO_NUM_NEGATIVE_SAMPLES)
