...
inline bool triangle_ray_intersection_unclamped(in Ray ray, in vec3 v0, in vec3 v1, in vec3 v2, float epsilon=1.e-5f)
{
  ...
  return intersectsPlane && sq_distance(closestPoint, p)<=epsilon;
}
